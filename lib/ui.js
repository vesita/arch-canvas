...
function ArchStudio(props) {
    ...
    var notePanel = notesOpen ? React.createElement('div', { className: 'ac-lib ac-notes' }, React.createElement('div', { className: 'ac-lib-head' }, React.createElement('span', { className: 'grow' }, '元素注释：' + noteListOpen.length + ' 条未解决'
        + (noteListDone.length ? '，' + noteListDone.length + ' 条已解决' : '')
        + '　·　未解决的每一步都会进入 AI 的上下文，已解决的不会'), React.createElement('button', { className: 'ac-btn', onClick: function () { setNotesOpen(false); } }, '收起')), noteListOpen.length === 0
    ...
    if (nodeSel) {
        dock = React.createElement('div', { className: 'ac-dock' }, React.createElement('h4', null, '节点 ' + nodeSel.id), React.createElement('div', { className: 'ac-grid' }, React.createElement('div', { className: 'ac-field full' }, React.createElement('label', null, '显示文本（回车生效，Shift+回车换行）'), React.createElement('textarea', {
            ...
            : '注释（写给 AI：这里的疑问 / 要求 / 背景）'), React.createElement('textarea', {
            className: 'ac-input', style: { height: 54, resize: 'vertical', fontFamily: 'inherit' },
    ...
    }, noteListOpen.length ? '注释 ' + noteListOpen.length : '注释') : null, tab === 'text' ? React.createElement('button', { className: 'ac-btn primary', onClick: applyDraft }, '应用回画布') : null, tab === 'text' ? React.createElement('button', { className: 'ac-btn', onClick: function () { setDraft(mermaidText); } }, '还原') : null), picker.open ? React.createElement('div', { className: 'ac-lib' }, React.createElement('div', { className: 'ac-lib-head' }, React.createElement('span', { className: 'grow' }, (external ? '当前打开：' + external : '当前：图库 ' + (libKey || '—'))
