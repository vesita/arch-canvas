...
function ArchStudio(props) {
    ...
    if (nodeSel && dockOpen) {
        ...
        dockBody = React.createElement('div', { className: 'ac-grid' }, React.createElement('div', { className: 'ac-field full' }, React.createElement('label', null, '标签（回车生效）'), React.createElement('input', { className: 'ac-input', value: edgeDraft, onChange: function (e) { setEdgeDraft(e.target.value); }, onBlur: commitEdgeLabel, onKeyDown: function (e) { if (e.key === 'Enter')
