...
function PendingNotesDock(props) {
    ...
    return React.createElement('div', { className: 'ac-pending' }, React.createElement('span', { className: 'ac-pending-n' }, '留言 ' + pending.length + ' 条待发' + (draft.trim() ? '（会追加到你已写的后面）' : '')), React.createElement('button', {
