    ...
    function toggleAiWrite(next) {
        ...
        rpc('setting:set', { aiWrite: !!next }).then(function (r) {
            if (r && r.ok)
                ...
                setAiWrite(!next);
                setStatus('切换 AI 改图开关失败：' + String((r && r.error) || '未知原因'));
            }
