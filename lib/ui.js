...
function ArchStudio(props) {
    ...
    for (var gi = 0; gi < groups.length; gi++) {
        ...
        if (fg) {
            ...
            inner.push(React.createElement('g', { key: 'g' + gb.id, className: 'ac-grp' + hueClassOf(hueOfGroup, gb.id) }, React.createElement('rect', { className: 'ac-group-box', x: gb.x, y: gb.y, width: gb.w, height: gb.h, rx: 12 }), React.createElement('text', { className: 'ac-group-lbl', x: gb.x + 12, y: gb.y + 17 }, String(gb.label == null ? gb.id : gb.label)), 
